...
if [[ "${HOSTNAME}" == *"login"* ]]; then
    ...
    swing_ld_library="/lcrc/project/EE-ECP/jkoo/sw/clang13.2/release_pragma-clang-loop/lib:/lcrc/project/perfopt/trandall/sw/llvm-install/usr/local/lib:/lcrc/project/perfopt/trandall/sw/llvm-install/usr/local/libexec"
...
date;
which mpicc;
python3 experiments.py --conf gc_300_experiment.ini --runstatus run --experiments rsbench --never-remove;
date;
