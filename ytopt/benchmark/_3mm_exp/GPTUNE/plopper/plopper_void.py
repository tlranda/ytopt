...
#         counter = random.randint(1, 10001) # To reduce collision increasing the sampling intervals
        counter = d_size[2:]
        interimfile = self.outputdir+"/"+str(counter)+"_run3_timer2.c"
...
#                 " " + d_size + " -DPOLYBENCH_TIME -O3 -o "+tmpbinary        
        ...
        cmd1 = "clang -fno-caret-diagnostics "  +interimfile +" " + kernel_dir + "/polybench.c" \
                + " -I" + kernel_dir + \
                " " + d_size + " -DPOLYBENCH_TIME -std=c99 -fno-unroll-loops -O3 -mllvm -polly -mllvm -polly-process-unprofitable -mllvm -polly-use-llvm-names -ffast-math -march=native -o "+tmpbinary
        print (cmd1)
